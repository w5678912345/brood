...
#
# 使用用法：
#   部署：mina deploy -f config/deploy-tian6.rb -v
#   停止：mina shutdown -f config/deploy-tian6.rb -v
#   其他命令参见：mina tasks
#
# **************
...
set :domain, '115.29.197.190'
set :deploy_to, '/root/apps/tian6.dabi.co'
set :user, 'root'

set :rails_env, 'production'

set :repository, 'ubuntu@control.dabi.co:repo/brood.git'
set :branch, 'tianyi'
