...
#
# 使用用法：
#   部署：mina deploy -f config/deploy-test-tian1-new.rb -v
#   停止：mina shutdown -f config/deploy-test-tian1-new.rb -v
#   其他命令参见：mina tasks
#
# **************
...
set :domain, '121.41.103.10'
set :deploy_to, '/root/apps/test_tian1.dabi.co'
set :user, 'root'
