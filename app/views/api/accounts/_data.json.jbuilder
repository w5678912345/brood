...
if @code == 1
    ...
    json.profile_name @account.account_profile.name if @account.account_profile
	  json.(@account,:no, :password,:server,:status,:today_pay_count,:gold_agent_level,:sellers,:sell_goods,:goods_price,:point,:online_ip,:is_bind_phone,:phone_id,:standing)
