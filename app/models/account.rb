...
class Account < ActiveRecord::Base
    ...
    # 账号可能发生的事件
    EVENT = ['bslock','bs_unlock_fail','bs_unlock_success','code_error','wrong_password','study_sailiya']
    ...
    attr_accessible :remark,:is_auto,:phone_id,:normal_at,:unlock_phone_id,:unlocked_at,:rms_file
